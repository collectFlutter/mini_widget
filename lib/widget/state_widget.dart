  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        ArcWidget(width * 0.7, startAngle: -10, sweepAngle: 110, color: Colors.grey[700]),
        ArcWidget(width * 0.7, startAngle: 170, sweepAngle: 110, color: Colors.grey[700]),
        StringWidget(label, rotateAngle: -45, fontSize: fontSize, color: color, width: width, height: width),
        Positioned(
